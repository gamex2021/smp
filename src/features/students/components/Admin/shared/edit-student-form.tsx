...
export default function EditStudentForm({ student, onClose }: EditStudentFormProps) {
    ...
    const form = useForm<z.infer<typeof formSchema>>({
        ...
        defaultValues: {
            ...
            bio: student?.bio ?? "",
            gender: (student.gender as "male" | "female" | "other" | "prefer_not_to_say") ?? "prefer_not_to_say",
        ...
        <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                ...
                <FormField
                    ...
                    render={({ field }) => (
                        <FormItem>
                            ...
                            <FormControl>
                                <Textarea placeholder="Student information..." className="resize-none" {...field} />
                            </FormControl>
                            <FormMessage />
                        </FormItem>
                    )}
                ...
                <FormField
                    ...
                    render={({ field }) => (
                        <FormItem>
                            ...
                            <FormDescription>Select the student&apos;s current class</FormDescription>
                            <FormMessage />
                        </FormItem>
                    )}
                />
                ...
                <div className="flex justify-end space-x-4">
                    ...
                    <Button type="submit" className="bg-[#4B6CB7] hover:bg-[#4B6CB7]/80" disabled={loading}>
