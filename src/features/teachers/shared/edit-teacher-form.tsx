...
export default function EditTeacherForm({ teacher, onClose }: EditTeacherFormProps) {
    ...
    const classesQuery = useQuery(api.queries.class.getClassesData, { domain })
    ...
    const isClassTeacher = teacher.assignedClasses && teacher.assignedClasses.length > 0
    ...
    const teacherSubjects =
        teacher.subjects
            ?.map((subject) => {
                ...
                const classForSubject = subjectsQuery?.find((s) => s.currentSubject?._id === subject?._id)?.currentClass
    ...
    const form = useForm<z.infer<typeof formSchema>>({
        ...
        defaultValues: {
            ...
            bio: teacher.bio ?? "",
            gender: (teacher.gender as "male" | "female" | "other" | "prefer_not_to_say") || "prefer_not_to_say",
            isClassTeacher: isClassTeacher,
            image: teacher.image ?? undefined,
            subjects: teacherSubjects as { subject: Id<"subjects">; classes: Id<"classes"> }[],
    ...
    async function onSubmit(values: z.infer<typeof formSchema>) {
        ...
        try {
            ...
            if (values?.profilePicture?.type) {
                ...
                const jsonResponse = (await result.json()) as { storageId: Id<"_storage"> }
        ...
        <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                ...
                <FormField
                    ...
                    render={({ field }) => (
                        <FormItem>
                                ...
                                <MultiSelect
                                    ...
                                    onChange={(values) => {
                                        const parsedValues = values.map(
                                            (value: string) => JSON.parse(value) as { subject: Id<"subjects">; classes: Id<"classes"> },
                                        )
                            ...
                            <FormDescription>Subjects Assigned to the teacher</FormDescription>
                            <FormMessage />
                        </FormItem>
                    )}
                />
                ...
                <FormField
                    ...
                    render={({ field }) => (
                        <FormItem>
                            ...
                            <FormDescription>Enter qualifications separated by commas.</FormDescription>
                            <FormMessage />
                        </FormItem>
                    )}
                />
                    ...
                    render={({ field: { value, onChange, ...field } }) => (
                        <FormItem>
                            ...
                            <div className="flex items-center space-x-4 mb-2">
                                ...
                                <FormDescription>Current profile picture. Upload a new one to replace it.</FormDescription>
                            </div>
                            <FormControl>
                                <Input
                                    type="file"
                            ...
                            <FormDescription>Upload a profile picture (max 5MB).</FormDescription>
                            <FormMessage />
                        </FormItem>
                    )}
                />
                    ...
                    render={({ field }) => (
                        <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4">
                            ...
                            <div className="space-y-1 leading-none">
                                ...
                                <FormDescription>Is this teacher assigned as a class teacher?</FormDescription>
                            </div>
                        </FormItem>
                    )}
                />
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem>
                                ...
                                <FormDescription>Select classes you want to assign to the teacher</FormDescription>
                                <FormMessage />
                            </FormItem>
                        )}
                    />
                ...
                <div className="flex justify-end space-x-4">
                    ...
                    <Button type="submit" className="bg-[#11321f]/80 hover:bg-[#11321f]/50" disabled={loading}>
