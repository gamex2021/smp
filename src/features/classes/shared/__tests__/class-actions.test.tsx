...
// Mock the EditClassModal and DeleteClassModal
jest.mock("../edit-class-modal", () => ({
  __esModule: true,
...
describe("ClassActions", () => {
  ...
  it("renders dropdown menu trigger", () => {
    render(<ClassActions classItem={mockClass} />)
    const trigger = screen.getByRole("button", { name: /class options/i })
