...
export default function RecentWorkspaceActivity({ workspaceId }: { workspaceId: Id<"workspace"> }) {

    // get documents
    const activities = useQuery(api.queries.workspace.getRecentWorkspaceActivities, {
        workspaceId
    })
    ...
    const getActivityText = (activity: Doc<"recentActivity">) => {
